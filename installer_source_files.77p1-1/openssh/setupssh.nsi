...
;OpenSSH for Windows 7.71-1, OpenSSL 1.0.2o-1
;Installer Script
...
;Chinese Simple language translations provided by Wair56
...
Name "OpenSSH for Windows 7.7p1-1"                   ;The name of the product
SetCompressor /SOLID /FINAL lzma                     ;Use lzma Compression
SetCompressorDictSize 64							 ;Saves a bit of space on the final exe
OutFile "setupssh-7.7p1-1.exe"                       ;This is the name of the output file
!packhdr tmp.dat "c:\upx\upx.exe --best -q tmp.dat"  ;Compress the NSIS header with UPX
RequestExecutionLevel admin
!define _VERSION "7.7.1.1" 							 ;must be numeric 4 digits 
!define _VERSION_NAME "7.7p1-1" 
